...
###########
    ...
    def kep_modify_user(self): ## ADDED to modify user requires three input from user - Description and Usergroup name and user to change
        server = self.kep_connect()
    ...
    def main(self):
        ...
        match attack_option:
            ...
            case "26": self.kep_add_udd_profile()
            case "-h":
